      ...
      <div className='sidebar sidebar--home'>
        <div className='foreign'>
          ...
          <ul className='foreign__list'>
            ...
            <li>LoadingBar GIF from LoadingBar.io</li>
          ...
          <section className='info-section'>
            ...
            <article className='info-article'>
              ...
              <p className='info-article__body'>
                ...
                each of them. You can search for a book by title, author or year. The
                list of books has an alternative view mode - the gallery of covers.
              </p>
            </article>
